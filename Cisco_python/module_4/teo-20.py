...
#1. Las Tuplas son colecciones de datos ordenadas e inmutables. Se puede pensar en ellas como listas inmutables. 
...
miTupla = 1, 2, 3,
#del miTupla[2]
#print(miTupla) ERROR, LAS TUPLAS NO SE PUEDEN CAMBIAR (ELIMINAR, ANEXAR O MODIFICAR)
del miTupla
#print(miTupla)    # NameError: name 'miTupla' is not defined, PORQUE YA NO EXISTE. SE BORRÓ

print("----2----")

#6. Puedes navegar a través de los elementos de una tupla con un bucle (Ejemplo 1), verificar si un elemento o no esta presente en la tupla 
#(Ejemplo 2), emplear la función len() para verificar cuantos elementos existen en la tupla (Ejemplo 3), o incluso unir o multiplicar tuplas 
#(Ejemplo 4):
