...
#Cuando se emplea dentro de una función, provoca la terminación inmediata de la ejecución de la función, y un retorno instantáneo 
#(de ahí el nombre) al punto de invocación.

#Nota: si una función no está destinada a producir un resultado, emplear la instrucción  return no es obligatorio, 
...
def felizAñoNuevo(deseos = True):
    ...
    print("Dos ...")
    print("Uno ...")
    if not deseos: #SI DESEOS ES TRUE, SIENDO EL ARGUMENTO DE LA INVOCACIÓN == FALSE, SE FRENA EL PROGRAMA POR "RETURN"
        return
...
#LO QUE SE RETORNE NO TIENE QUE ESTAR EN LOS PARÁMETROS DE LA FUNCIÓN. MUY IMPORTANTE
...
x = funcion_aburrida() #DE ESTA MANERA SE OBTIENE EL VALOR GENERADO POR LA FUNCIÓN PARA MANIPULARSE EN PRÓXIMOS PROCESOS
...
#Si una función intenta devolver un resultado útil, debe contener la segunda variante de la instrucción return (RETURN + EXPRESIÓN)
