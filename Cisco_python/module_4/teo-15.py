...
#AQUÍ, LA RECURSIVIDAD ES UNA TÉCNICA DONDE UNA FUNCIÓN SE INVOCA A SÍ MISMA.
...
#Si, existe algo de riesgo. Si no se considera una condición que detenga las invocaciones recursivas, el programa puede entrar 
#en un bucle infinito. Se debe ser cuidadoso.
