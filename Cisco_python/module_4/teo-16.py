...
#1. Una función puede invocar otras funciones o incluso a sí misma. Cuando una función se invoca a si misma, 
#se le conoce como recursividad, y la función que se invoca a si misma y contiene una condición de terminación 
...
#dividir el código en trozos más pequeños. Sin embargo, se debe tener mucho cuidado ya que es muy fácil cometer un error 
#y crear una función la cual nunca termine. También se debe considerar que las funciones recursivas consumen mucha memoria, 
#y por lo tanto pueden ser en ocasiones ineficientes.
