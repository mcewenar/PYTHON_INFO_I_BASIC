#Arreglos tridimensionales (IMPORTANTE)
...
#El primer índice (0 a 2) selecciona uno de los edificios; el segundo(0 a 14) selecciona el piso, el tercero (0 a 19) 
#selecciona el número de habitación. Todas las habitaciones están inicialmente desocupadas.
