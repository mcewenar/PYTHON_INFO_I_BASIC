...
#del laboratorio anterior (3.1.2.10) y crear un mejor devorador de vocales (bonito) mejorado! Escribe un programa que use:
...
#Usa la ejecución condicional y la instrucción continue para "comer" las siguientes vocales A , E , I , O , U de la 
# palabra ingresada.
...
# Utiliza la operación de concatenación para pedirle a Python que combine las letras seleccionadas en una cadena más 
# larga durante los siguientes giros de ciclo, y asignarlo a la variable palabrasinVocal.
